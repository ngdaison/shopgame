      ...
      <div class="header-element">
        ...
        <a href="javascript:void(0);" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
          <div class="d-flex align-items-center">
            <div class="me-sm-2 me-0 flex-shrink-0">
              <img src="{{ Helper::getValidImage(Auth::user()->avatar, '/images/avatar/av-1.svg') }}" alt="img" width="32" height="32" class="rounded-circle" style="border-radius: 50% !important; aspect-ratio: 1/1 !important; object-fit: cover;">
            </div>
            <div class="d-sm-block d-none">
              <p class="fw-semibold mb-0 lh-1">{{ Auth::user()->username }}</p>
              <span class="op-7 fw-normal d-block fs-11">Partner Account</span>
            </div>
          </div>
        </a>
        ...
        <ul class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
          <li>
            <a class="dropdown-item d-flex" href="{{ route('home') }}">
                <i class="ti ti-home fs-18 me-2 op-7"></i>Về Trang Chủ
            </a>
          </li>
          <li>
            <a class="dropdown-item d-flex" href="javscript:void(0)" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
