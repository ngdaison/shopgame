...
@section('content')
  <div class="card custom-card">
    ...
    <div class="card-body">
      <form action="{{ route('admin.posts.update', ['id' => $post->id]) }}" method="POST" enctype="multipart/form-data" class="default-form axios-form" data-reload="true">
        @csrf
        <div class="mb-3 row">
          <div class="col-md-6">
        ...
        <div class="mb-3">
          <label for="thumbnail" class="form-label">Ảnh bìa - <a href="{{ Helper::getValidImage($post->thumbnail) }}" target="_blank">xem ảnh</a></label>
        ...
        <div class="mb-3 text-center">
          <button class="btn btn-primary-gradient">Cập nhật ngay</button>
        </div>
      </form>
    </div>
  </div>
