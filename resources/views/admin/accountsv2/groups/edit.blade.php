...
@section('title', 'Admin: Edit Accounts Group')
@section('styles')
<style>
  .choices__inner {
      min-height: 44px;
...
@section('content')
  <div class="card custom-card">
    ...
    <div class="card-body">
      <form action="{{ route('admin.accountsv2.groups.update') }}" method="POST" enctype="multipart/form-data" class="default-form axios-form" data-reload="true">
        @csrf
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="sub_name" name="sub_name" value="{{ $group->sub_name }}">
        </div>
        <div class="mb-3">
