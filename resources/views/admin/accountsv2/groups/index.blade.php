...
@section('content')
  <div class="card custom-card">
    <div class="card-header justify-content-between">
      <div class="card-title">Quản lý nhóm của Shop Nick V2</div>
      <div class="d-flex flex-wrap gap-2">
        <form action="{{ route('admin.accountsv2.groups') }}" method="GET" class="d-flex gap-2">
          ...
          <tbody>
            @foreach ($groups as $item)
              <tr>
                ...
                <td>
                  <a href="{{ route('admin.accountsv2.groups.edit', ['id' => $item->id]) }}" class="badge bg-primary-gradient text-white me-1"><i class="fa fa-edit"></i> sửa</a>
    ...
    <div class="card-footer">
      <a href="{{ route('admin.accountsv2.groups.create') }}" class="btn btn-primary"><i class="fa fa-edit"></i> Thêm nhóm mới</a>
...
@section('scripts')
  <script>
    ...
    const updatePriority = $debounce(function(id, val) {
        axios.post('{{ route('admin.accountsv2.groups.update-priority') }}', {
            id: id,
            priority: val,
            _token: '{{ csrf_token() }}'
        }).then(res => {
