...
@section('content')
  <div class="row mb-3">
    <div class="col-12 d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('admin.deposit.cards.config') }}" class="btn btn-purple btn-sm shadow-sm">
  ...
  <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                <div class="card card-stats h-100 mb-0 shadow-sm">
                    <div class="card-body">
                        <h3>{{ number_format($stats['cards']['total']) }}đ</h3>
            ...
            <div class="col-md-6 mb-3">
                <div class="card card-stats h-100 mb-0 shadow-sm">
                    <div class="card-body">
                        <h3>{{ number_format($stats['cards']['month']) }}đ</h3>
            ...
            <div class="col-md-6 mb-3">
                <div class="card card-stats h-100 mb-0 shadow-sm">
                    <div class="card-body">
                        <h3>{{ number_format($stats['cards']['week']) }}đ</h3>
                        <h5>Trong tuần</h5>
            ...
            <div class="col-md-6 mb-3">
                <div class="card card-stats h-100 mb-0 shadow-sm">
                    <div class="card-body">
                        <h3>{{ number_format($stats['cards']['today']) }}đ</h3>
                        <h5 class="d-flex align-items-center">
                            Hôm nay 
                            @if($stats['cards']['today'] == 0)
    ...
    <div class="col-md-7 mb-3">
        <div class="card h-100 shadow-sm mb-0">
            <div class="card-body">
                <div class="chart-title mb-3">THỐNG KÊ NẠP THẺ THÁNG {{ now()->format('m') }}</div>
  ...
  <div class="card custom-card shadow-sm">
      <div class="card-header border-bottom-0 pb-0 d-flex justify-content-between align-items-center">
        <div class="section-title">LỊCH SỬ NẠP THẺ CÀO</div>
      ...
      <div class="card-body">
        <div class="mb-2">
            <form id="filter" onsubmit="$('#basic-1').DataTable().ajax.reload(); return false;">
              <input type="hidden" id="type" value="deposit-card">
              <div class="row g-2">
                <div class="col-md-2">
                ...
                <div class="col-md-2">
                    <label for="serial" class="form-label">Serial / Mã thẻ</label>
                    <input type="text" class="form-control" id="serial" name="serial" placeholder="Serial hoặc Mã thẻ">
                </div>
                <div class="col-md-2">
...
<script>
    ...
    function clearAllHistory() {
        Swal.fire({
            ...
            text: "Toàn bộ lịch sử nạp thẻ (trừ Product Manager) sẽ bị ẩn khỏi Admin!",
            icon: 'warning',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                axios.post('{{ route('admin.deposit.cards.clear-all') }}', {}, {
                    headers: {
