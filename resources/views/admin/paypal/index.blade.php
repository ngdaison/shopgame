...
@section('title', 'Phương thức thanh toán Paypal')
@section('css')
  <style>
...
@section('content')
  <div class="row mb-3">
    <div class="col-12 d-flex justify-content-between align-items-center">
        ...
        <div>
            <a href="{{ route('admin.deposit.paypal.config') }}" class="btn btn-purple btn-sm shadow-sm">
  ...
  <div class="row">
    ...
    <div class="col-md-7 mb-3">
        <div class="card h-100 shadow-sm mb-0">
            <div class="card-body">
                <div class="chart-title mb-3">THỐNG KÊ NẠP PAYPAL THÁNG {{ now()->format('m') }}</div>
   ...
   <div class="card custom-card shadow-sm">
       <div class="card-header border-bottom-0 pb-0 d-flex justify-content-between align-items-center">
         <div class="section-title">LỊCH SỬ NẠP PAYPAL TỰ ĐỘNG</div>
 ...
 <script>
     ...
     $(document).ready(function() {
       ...
       $("#basic-1").DataTable({
         ...
         serverSide: true,
         ajax: {
           url: '{{ route('admin.deposit.paypal.api') }}',
           type: 'GET',
           headers: {
    ...
    function clearAllHistory() {
        Swal.fire({
            ...
            text: "Toàn bộ lịch sử nạp PayPal (trừ Product Manager) sẽ bị ẩn khỏi Admin!",
            icon: 'warning',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                axios.post('{{ route('admin.deposit.paypal.clear-all') }}', {}, {
                    headers: {
