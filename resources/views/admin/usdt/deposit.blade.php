...
@section('title', 'Admin: Phương thức thanh toán USDT')
@section('css')
  <style>
...
@section('content')
    ...
    <div class="col-12 d-flex justify-content-between align-items-center">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
                <li class="breadcrumb-item"><a href="/admin">Nạp tiền</a></li>
                <li class="breadcrumb-item active" aria-current="page">USDT</li>
            </ol>
        </nav>
        <div>
            <a href="{{ route('admin.deposit.usdt.config') }}" class="btn btn-purple btn-sm shadow-sm">
  ...
  <div class="row">
    ...
    <div class="col-md-7 mb-3">
        <div class="card h-100 shadow-sm mb-0">
            <div class="card-body">
                <div class="chart-title mb-3">THỐNG KÊ NẠP USDT THÁNG {{ now()->format('m') }}</div>
  ...
  <div class="card custom-card shadow-sm">
      <div class="card-header border-bottom-0 pb-0 d-flex justify-content-between align-items-center">
        <div class="section-title">LỊCH SỬ NẠP USDT TỰ ĐỘNG</div>
      ...
      <div class="card-body">
        <div class="mb-2">
            <form id="filter" onsubmit="$('#basic-1').DataTable().ajax.reload(); return false;">
              <input type="hidden" id="type" value="usdt">
              <div class="row g-2">
                <div class="col-md-2">
...
<script>
    ...
    $(document).ready(function() {
      ...
      $("#basic-1").DataTable({
        ...
        serverSide: true,
        ajax: {
          url: '{{ route('admin.deposit.usdt.api') }}',
          type: 'GET',
          headers: {
    ...
    function clearAllHistory() {
        Swal.fire({
            ...
            text: "Toàn bộ lịch sử nạp USDT (trừ Product Manager) sẽ bị ẩn khỏi Admin!",
            icon: 'warning',
            showCancelButton: true,
            ...
            if (result.isConfirmed) {
                axios.post('{{ route('admin.deposit.usdt.clear-all') }}', {}, {
                    headers: {
